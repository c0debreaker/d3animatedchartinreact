...
let App = React.createClass({
  ...
  changeData: function() {
    ...
    let buttonOrGraph = this.state.show ? <div><Chart data={ this.state.data } /><button onClick={this.changeData}>Change Data</button></div> : <button onClick={this.show}>Show chart</button>
  return buttonOrGraph;
	}
})
